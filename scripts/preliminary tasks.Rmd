...
# Partition data
partitions_bigrams <- headers_bigrams_tfidf %>% inital_split(prop = 0.8)
...
proj_out_bigrams <- projection_fn(.dtm = train_dtm_bigrams, .prop = 0.7)
train_dtm_projected_bigrams <- proj_out_bigrams$data

# how many components were used?
proj_out_bigrams$n_pc
```
